...
export default function MovieInfo() {
  ...
  return (
    <div className="mt-24 bg-black justify-around xs:p-5 xs:block sm:p-3 md:p-5 md:flex xl:flex xl:p-10">
      ...
      <ul className="px-4 sm:px-10 py-5 text-mkLightGray xs:w-full xs:text-xs sm:text-sm md:text-base xl:w-3/5">
